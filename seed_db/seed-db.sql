...
('Class Teachers', 'markets', NULL, 'academics_parent', 2, 'menu-screen', NULL),
...
('Class Teachers Edit', 'markets/edit/:id', NULL, 'academics_parent', NULL, 'screen', NULL),
...
('Get class with teacher details', '/api/v1/markets', NULL, 'academics_parent', NULL, 'api', 'GET'),
('Add class teacher', '/api/v1/markets', NULL, 'academics_parent', NULL, 'api', 'POST'),
('Get class teacher detail', '/api/v1/markets/:id', NULL, 'academics_parent', NULL, 'api', 'GET'),
('Update class teacher detail', '/api/v1/markets/:id', NULL, 'academics_parent', NULL, 'api', 'PUT'),
...
('payments', 'payments', NULL, 'hr_parent', 3, 'menu-screen', NULL),
...
('Edit payment', 'payments/edit/id', NULL, 'hr_parent', NULL, 'screen', NULL),
('Get all payments', '/api/v1/payments', NULL, 'hr_parent', NULL, 'api', 'GET'),
('Add new payment', '/api/v1/payments', NULL, 'hr_parent', NULL, 'api', 'POST'),
('Get payment detail', '/api/v1/payments/:id', NULL, 'hr_parent', NULL, 'api', 'GET'),
('Update payment detail', '/api/v1/payments/:id', NULL, 'hr_parent', NULL, 'api', 'PUT'),
('Delete payment', '/api/v1/payments/:id', NULL, 'hr_parent', NULL, 'api', 'DELETE'),
-- end hr
